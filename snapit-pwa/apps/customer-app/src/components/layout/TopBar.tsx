...
export const TopBar: React.FC = () => {
  return (
    <header className="sticky top-0 z-40 bg-white backdrop-blur-md border-b border-gray-100 shadow-sm px-4 h-14 flex items-center justify-between">
      {/* Logo */}
      ...
      >
        ...
        <div className="flex items-center gap-1 mt-0.5">
          ...
          <span className="text-sm font-black text-gray-900">Robertsonpet</span>
