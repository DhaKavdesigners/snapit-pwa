...
export const mockShoppingStores: Store[] = [
  { id: 'g1', name: 'Mhetha Stores',  logoUrl: '/images/stores/mhetha-stores/metha-stores.avif',        fallbackLogoUrl: 'https://picsum.photos/seed/ohr5ug/200/200', rating: 4.5, category: 'grocery', isOpen: true },
  ...
  { id: 'd1', name: 'Nandhini KGF',   logoUrl: '/images/stores/nandhini-kgf/logo.jpg',          fallbackLogoUrl: 'https://picsum.photos/seed/7cmzc/200/200', rating: 4.9, category: 'grocery', isOpen: true },
];
...
const mhethaProducts: Product[] = [
  { id: 'ms01', name: 'Maggi 2-Minute Noodles',      price: 2800,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Snacks & Beverages', description: '140 g (Pack of 2) • Instant masala noodles', deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/maggi-noodles.jpg',          fallbackImageUrl: 'https://picsum.photos/seed/kd7clq/400/400' },
  { id: 'ms02', name: 'Fortune Sunflower Oil',        price: 13500, storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Everyday Essentials', description: '1 L Pouch • Refined sunflower oil',            deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/sunflower-oil.jpg',          fallbackImageUrl: 'https://picsum.photos/seed/5kgbe8/400/400' },
  { id: 'ms03', name: 'Tata Tea Gold',               price: 4500,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Snacks & Beverages', description: '250 g • Strong & aromatic tea',                deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/tata-tea.jpg',              fallbackImageUrl: 'https://picsum.photos/seed/w8ghb/400/400' },
  { id: 'ms04', name: 'Parle-G Gold Biscuits',       price: 1000,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Snacks & Beverages', description: '450 g • Classic glucose biscuits',             deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/parle-g.jpg',               fallbackImageUrl: 'https://picsum.photos/seed/2wvwdu/400/400' },
  { id: 'ms05', name: 'Lays Classic Salted',         price: 2000,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Snacks & Beverages', description: '73 g • Crispy potato chips',                   deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/lays-chips.jpg',            fallbackImageUrl: 'https://picsum.photos/seed/y2bib/400/400' },
  { id: 'ms06', name: 'Surf Excel Quick Wash',       price: 9500,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Home Essentials',    description: '1 kg • Laundry detergent powder',              deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/surf-excel.jpg',            fallbackImageUrl: 'https://picsum.photos/seed/u81fx1/400/400' },
  { id: 'ms07', name: 'Dove Soap Bar',               price: 3500,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Personal Care',      description: '3×75 g Pack • Moisturizing beauty bar',        deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/dove-soap.jpg',             fallbackImageUrl: 'https://picsum.photos/seed/fjh8m8/400/400' },
  { id: 'ms08', name: 'Head & Shoulders Shampoo',    price: 17500, storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Personal Care',      description: '340 ml • Anti-dandruff shampoo',               deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/head-shoulders.jpg',        fallbackImageUrl: 'https://picsum.photos/seed/4adtm8/400/400' },
  { id: 'ms09', name: 'Tata Salt (Iodized)',         price: 2500,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Cooking Essentials', description: '1 kg • Vacuum evaporated iodized salt',        deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/tata-salt.jpg',             fallbackImageUrl: 'https://picsum.photos/seed/wfotlq/400/400' },
  { id: 'ms10', name: 'Nivea Soft Cream',            price: 14500, storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Personal Care',      description: '200 ml • Light moisturizing cream',            deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/nivea.jpg',                 fallbackImageUrl: 'https://picsum.photos/seed/3tydwl/400/400' },
  ...
  { id: 'ms13', name: 'Frooti Mango Drink',          price: 2000,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Snacks & Beverages', description: '200 ml Tetrapack • Fresh n Juicy mango drink',  deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/frooti.jpg',                fallbackImageUrl: 'https://picsum.photos/seed/froo01/400/400' },
  ...
  { id: 'ms16', name: 'Lays Magic Masala',           price: 2000,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Snacks & Beverages', description: '73 g • India\'s favourite masala flavour',       deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/lays-masala.jpg',           fallbackImageUrl: 'https://picsum.photos/seed/laysm1/400/400' },
  // ── Extra Masalas ───────────────────────────────────────────────────────
  { id: 'ms17', name: 'Everest Chicken Masala',      price: 5500,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Cooking Essentials', description: '100 g • Restaurant-style spice blend',         deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/chicken-masala.jpg',        fallbackImageUrl: 'https://picsum.photos/seed/evcm01/400/400' },
  { id: 'ms18', name: 'Catch Turmeric Powder',       price: 3000,  storeId: 'g1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Cooking Essentials', description: '100 g • Pure haldi for everyday cooking',      deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/turmeric.jpg',              fallbackImageUrl: 'https://picsum.photos/seed/trmr01/400/400' },
];
