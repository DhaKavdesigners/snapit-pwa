...
const mhethaProducts: Product[] = [
  ...
  { id: 'ms05', name: 'Lays Classic Salted Chips',   price: 2000,  storeId: 's1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Snacks & Beverages', description: '73 g • Crispy potato chips',                   deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/lays-chips.jpg',            fallbackImageUrl: 'https://picsum.photos/seed/y2bib/400/400' },
  ...
  { id: 'ms10', name: 'Nivea Soft Skincare Cream',   price: 14500, storeId: 's1', storeName: 'Mhetha Stores', category: 'grocery', subCategory: 'Personal Care',      description: '200 ml • Light moisturizing cream',            deliveryEtaMinutes: 10, inStock: true, imageUrl: '/images/products/nivea.jpg',                 fallbackImageUrl: 'https://picsum.photos/seed/3tydwl/400/400' },
];
